...
fetch("https://api.thecatapi.com/v1/images/search?limit=10&breed_ids=beng&api_key=live_1EeIlchSbiPqtqiQKzkGTusxyD9IakCtsEBlF35SFC2jymIfr1ARqibsKGvaI4nD").then((data)=>{
  console.log(data);
  return data.json();
}).then((objectData)=>{
