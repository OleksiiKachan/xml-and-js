const passengers_info = {
  ...
  const passenger_list = passengers_info.passengers.data.passenger;
  const passenger_total_trips = passenger_list.reduce(
	(totaltrips, passenger_list) => {
	  return totaltrips + passenger_list.trips;
	},
	0
  );
  
  console.log(
	"Total count of all the trips made by all the passengers = " + String(passenger_total_trips)
  );
