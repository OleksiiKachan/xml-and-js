...
function gettingTotalTrips(pData) {
    const pList = pData.passengers.data.passenger;
    return pList.reduce((totalTrips, passenger) => 
    {
        return totalTrips + Number(passenger.trips);
    }, 0);
}
//Here using reduce() method to count the trips from the array = 'pList'. Initial value has been set to 0.

console.log(gettingTotalTrips(pData));