inc = (a) => { return new Promise((resolve) => { resolve(a + 1);});};
  
sum = (a, b) => {return new Promise((resolve) => {resolve(a + b);});};
...
avg = (a, b) => {return new Promise((resolve) => {sum(a, b).then((value) => resolve(value / 2));});};
...
split = (sep = " ") => {return new Promise((resolve) => {resolve(this.name.split(sep));});};}
