const xhr = new XMLHttpRequest();
            ...
            function createBuilding(b)
            {
                ...
                `<article class="building">
                    <img class="building-icon start-date-icon" src="/project-01/displayConstruction2/icons/calendarStart.png" alt="Calendar icon"/>
                    <div class="building-info start-date"> Start Date: ${b.startDate} </div>
                    <img class="building-icon end-date-icon" src="/project-01/displayConstruction2/icons/calendarEnd.png" alt="Calendar icon"/>
                    <div class="building-info end-date"> End Date: ${b.endDate}</div>
                    <img class="building-icon address-icon" src="/project-01/displayConstruction2/icons/address.png" alt="Address icon"/>
                    <div class="building-info address">Address: ${b.street}, ${b.city}, ${b.region}, ${b.country}</div>
                    <img class="building-icon contractor-icon" src="/project-01/displayConstruction2/icons/contractor.png" alt="Contractor icon"/>
