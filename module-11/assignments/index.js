...
function applyFilter(){
  showTracks = document.getElementById('rb-true').checked;
  renderGenres(currentFilterTerm, showTracks);
}

const renderGenres = async (filterTerm, showTracks = true) => {
  let source = _data;
...
const onSubmit = (event) => {
  ...
  currentFilterTerm = event.target.term.value;
  renderGenres(currentFilterTerm, showTracks);
};