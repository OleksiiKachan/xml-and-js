...
inc(5)
	.then((v) => console.log('1) inc(5) =', v))
	.then(() => sum(1, 3))
	.then((v) => console.log('2) sum(1, 3) =', v))
	.then(() => max(8, 6))
	.then((v) => console.log('3) max(8, 6) =', v))
	.then(() => avg(8, 6))
	.then((v) => console.log('4) avg(8, 6) =', v))
	.then(() => obj.split())
	.then((v) => console.log('5) obj.split() =', v))
	.then(() => Person.of('Marcus Aurelius'))
	.then((p) => p.split())
	.then((v) => console.log('6) person.split() =', v));