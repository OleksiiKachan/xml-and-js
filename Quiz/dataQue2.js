...
function TripCount(data) {
    const PassangerData = data.passengers.data.passenger;
    return PassangerData.reduce((TripNum, passenger) => 
    {
        return TripNum + Number(passenger.trips);
    }, 0);
}
console.log('total trip : ' , TripCount(data));
