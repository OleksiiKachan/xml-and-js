const developers = [
   ...
   const parsed = developers.map((developer, index) => ({
    id: developer.id,
    firstname: developer.first_name + index,
    lastname: developer.last_name + index,
    gender: developer.gender,
    ipaddress: developer.ip_address + index,
    fullName: `${developer.first_name} ${developer.last_name}`,
    fullName: `full name: ${developer.first_name} ${developer.last_name}`,
   }));
   console.log(parsedc);

   const filtered = data.filter((developer) => developer.id > 5);
