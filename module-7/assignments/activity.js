...
// convert data into new format
const parsed = data.map(student => {
    return {
        id: student.id,
...
console.log('parsed with map')
console.log(parsed);

// filter out data to have ids greater than 5 only
const filtered = data.filter(student => 
    student.id > 5
);

console.log('filtered with filter')
