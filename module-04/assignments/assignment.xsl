      ...
      <body> 
        ...
        <ul>
            <xsl:for-each select="catalog/product">
                <li><article><h3><xsl:value-of select="@product_id"/></h3><p><xsl:value-of select="@description"/></p> 
                <table border="1"> 
                  <tr bgcolor="#9acd32"> 
                    <th>Item Number</th> <th>Price</th> <th>Gender</th> 
                    <th>Small</th>  <th>Medium</th>
                    <th>Large</th> <th>Extra Large</th>  
                  </tr> 
                  ...
                  <tr> 
                    ...
                    <td>
                      <xsl:choose>
                        ...
                        <xsl:otherwise>Universal</xsl:otherwise>
                        </xsl:choose>
                    </td> 
                    <td>
                ...
                </xsl:for-each></table> </article></li></xsl:for-each>
