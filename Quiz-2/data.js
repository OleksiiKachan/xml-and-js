...
function Trips(){
var passstr=JSON.stringify(passengerlist);

var passObj=JSON.parse(passstr)



var passengerarray=passObj.passengers.data.passenger;

var count=0
passengerarray.forEach(item => {
    
    count=count+item.trips;
});

console.log("The total count of all the trips made by all the passengers :" ,count);
}
