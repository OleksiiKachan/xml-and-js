const info = [
  ...
  console.log("------Array of Active accounts------");
  console.log(filtered);

  const highbal=info.reduce((hghbal,{balance})=>{
    if(hghbal<balance){
        return balance;
    }else{
        return hghbal;
...
const accountholdername = info.reduce((actholdernames,{name})=>{
    if(actholdernames===""){
        return name;
    }
    else{
