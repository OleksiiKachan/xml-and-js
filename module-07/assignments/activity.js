...
const whole_data_ids = data.map((people) => {
    return{
        id: people.id,
...
console.log(whole_data_ids); //it shows all data which is stored in the whole_data_ids variable
const filtered_ids = data.filter((item) => item.id > 5); //it shows only data whose id is greater than 5
