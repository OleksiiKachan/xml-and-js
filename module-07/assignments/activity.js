...
var parsed = data.map(({ id, first_name, last_name, gender, ip_address }) => {
...
console.log("\n---save it into `filtered` variable, and console.log the result---\n");

var filtered = data.filter((item) => item.id > 5);
