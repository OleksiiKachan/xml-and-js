// saving the json data into data variable.
const data=[
    {
      "id": 1,
      "first_name": "Husain",
...
// parsing the data into parsed id variable
const parsed_id = data.map(({ id, first_name, last_name, gender, ip_address }) => {
    return {
        id,
...
// filtering the parsed data to get the id > 5.
const filtered = parsed_id.filter((id) => {
    return id.id > 5;
});
