...
const parsed = data.map(({ id, first_name, last_name, gender, ip_address }) =>
    ({ id: id.toString(), firstName: first_name, lastName: last_name, gender: gender, ipAddress: ip_address }));

console.log("-----Find the Parsed Data Below-----");
console.log(parsed);

const filtered = data.filter(({ id }) => id > 5);
console.log("----- Below is the Filtered Data-----");
