            ...
            <body>
                ...
                <xsl:for-each select="retail/data">
                    <ul style="margin-top: 50px; margin-bottom: 5px;">
                        <li><strong style="font-size: 29px;">#<xsl:value-of select="id"/></strong></li>
                        <li><strong style="font-size: 23px;">Address: </strong><xsl:value-of select="concat(address/street,', ',address/city,', ',address/country)"/></li>
                        <li>
                            <h2 style="font-size: 23px; margin-top: 30px; margin-bottom: 5px;">Employees</h2>
                            <xsl:for-each select="employees/detail">
                            <br/>
                            <ul style="background-color: rgba(0, 0, 0, 0.05); padding: 20px 40px; border-radius: 18px; margin-right: 40px;">
                        ...
                        <li>
                            <h2 style="font-size: 24px; margin-top: 48px; margin-bottom: 5px;">Products</h2>
                            <xsl:for-each select="products/detail">
                            <br/>
                            <ul style="background-color: rgba(0, 0, 0, 0.05); padding: 20px 38px; border-radius: 20px; margin-right: 38px;">
