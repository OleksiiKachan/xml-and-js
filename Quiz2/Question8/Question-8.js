const accounts = [
  ...
  const activeAccount = accounts.filter((account) => account.isActive = true);
  console.log("*********************Active Account Array************************")
  console.log (activeAccount);
//-----------------------------------------------------------------


  const highestBalance = accounts.reduce((accum,account) =>{
    return Math.max(account.balance);
 },0);

 console.log ("The highest balance : "+ highestBalance);

//-----------------------------------------------------------------
//Aycan Lizor_N01534088
const friendNames = accounts.map((account) =>{
...
//------------------------------------------------------------
//Aycan Lizor_N01534088
const peopleName = accounts.map((account) =>{
  return account.name
});
