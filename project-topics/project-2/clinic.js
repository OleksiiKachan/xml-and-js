const apiKey = "x1kfFYRbQ8hI7b1k4p5Av1n0FTu2omkxnIkBROiH";

let _data = [];

const getToken = async () => {
  const result = await fetch("https://api.fda.gov/food/enforcement.json?search=report_date:[20040101+TO+20131231]&limit=1", {
    method: "POST",
    headers: {
