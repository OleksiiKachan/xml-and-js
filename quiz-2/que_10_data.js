...
console.log("Total number of trips by passenger: ")
function Trip_Count(data) {
    const passanger_Data = data.passengers.data.passenger;
    return passanger_Data.reduce((TripsNumber, passenger) => 
    {
        return TripsNumber + Number(passenger.trips);
    }, 0);
}
console.log(Trip_Count(data));
